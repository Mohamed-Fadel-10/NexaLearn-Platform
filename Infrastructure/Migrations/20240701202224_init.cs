        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionNumbers = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UsersQuizFeedbacks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UsersQuizFeedbacks_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_UsersQuizFeedbacks_FeedBack_FeedbackId",
                        column: x => x.FeedbackId,
                        principalTable: "FeedBack",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
                    table.ForeignKey(
                        name: "FK_UsersQuizFeedbacks_Quiz_QuizId",
                        column: x => x.QuizId,
                        principalTable: "Quiz",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.NoAction);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrueFalse = table.Column<bool>(type: "bit", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersQuizFeedbacks_FeedbackId",
                table: "UsersQuizFeedbacks",
                column: "FeedbackId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersQuizFeedbacks_QuizId",
                table: "UsersQuizFeedbacks",
                column: "QuizId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersQuizFeedbacks_UserId",
                table: "UsersQuizFeedbacks",
                column: "UserId");
        }
